...
int error_count = 0;
   ...
   error_count = copy_to_user(buffer, message, size_of_message);
	printk(KERN_INFO "AQQQQQQQQQQQQQQQQUUUUUUUUUUIIIII: %s", buffer);
...
pr_info(" A keyzinha: %s", key);
pr_info("O ivv: %s", iv);
printk(KERN_INFO "A key : %s", key);
printk(KERN_INFO "A key iv>: %s", iv);
   printk(KERN_INFO "balaibalaibalai: \n");
